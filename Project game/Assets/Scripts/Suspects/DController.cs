        ...
        if (collider.tag == "GoalNode" && (collider.gameObject.name==target.name))
        {
            ...
            switch (random)
            {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    target = guestRoom3.transform.GetChild(0);
                    break;
                case 4:
                    target = guestRoom3.transform.GetChild(1);
                    break;
                case 5:
                    target = guestRoom3.transform.GetChild(2);
                    break;
                case 6:
                    target = diningRoom.transform.GetChild(0);
                    break;
                case 7:
                ...
                case 11:
                    ...
                    break;
                case 12:
                    target = storageRoom.transform.GetChild(0);
                    break;
                case 13:
                ...
                case 19:
                    ...
                    break;
                case 20:
                    target = mBedroom.transform.GetChild(0);
                    break;
                case 21:
                    target = mBedroom.transform.GetChild(1);
                    break;
                case 22:
                    target = mBedroom.transform.GetChild(2);
                    break;
                case 23:
