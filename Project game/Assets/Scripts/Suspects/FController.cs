        ...
        if (collider.tag == "GoalNode" && (collider.gameObject.name==target.name))
        {
            ...
            switch (random)
            {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    target = guestRoom2.transform.GetChild(0);
                    break;
                case 4:
                    target = guestRoom2.transform.GetChild(1);
                    break;
                case 5:
                    target = diningRoom.transform.GetChild(1);
                    break;
                case 6:
                    target = kitchen.transform.GetChild(0);
                    break;
                case 7:
                ...
                case 8:
                    ...
                    break;
                case 9:
                    target = garage.transform.GetChild(2);
                    break;
                case 10:
                    target = pantry.transform.GetChild(1);
                    break;
                case 11:
                ...
                case 12:
                    ...
                    break;
                case 13:
                    target = warRoom.transform.GetChild(0);
                    break;
                case 14:
                    target = warRoom.transform.GetChild(1);
                    break;
                case 15:
                    target = warRoom.transform.GetChild(2);
                    break;
                case 16:
                    target = utility.transform.GetChild(0);
                    break;
                case 17:
                ...
                case 19:
                    ...
                    break;
                case 20:
                    target = library.transform.GetChild(0);
                    break;
                case 21:
                ...
                case 24:
                    ...
                    break;
                case 25:
                    target = trophyRoom.transform.GetChild(2);
                    break;
                case 26:
                    target = trophyRoom.transform.GetChild(3);
                    break;
                case 27:
